  ...
  return (
    <div className="animate-fade-in w-full max-w-2xl">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-serif font-bold text-neutral-950 mb-2">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {METHODS.map((method) => (
          <button
            ...
            className="p-4 border border-neutral-200 rounded-lg hover:bg-neutral-50 hover:border-neutral-400 transition-all duration-200 text-center focus:outline-none focus:ring-2 focus:ring-neutral-400"
          >
            <p className="font-semibold text-neutral-950">{method.label}</p>
